/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 46a1eaf5476e875b1acc9a13d4d2ab45)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		UPLOAD_WORKFLOW: Workflow<Parameters<import("./workers/app").UploadWorkflow['run']>[0]['payload']>;
	}
}
