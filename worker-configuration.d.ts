/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 32f4837b530d6d1f1653f5aeb1976aee)
// Runtime types generated with workerd@1.20260420.1 2026-02-14 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
		durableNamespaces: "Sandbox" | "ImportProgress";
	}
	interface Env {
		YOTO_AUTH_SECRET: string;
		RESEND_API_KEY: string;
		SANDBOX: DurableObjectNamespace<import("./workers/app").Sandbox>;
		IMPORT_PROGRESS: DurableObjectNamespace<import("./workers/app").ImportProgress>;
		IMPORT_WORKFLOW: Workflow<Parameters<import("./workers/app").ImportWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "YOTO_AUTH_SECRET" | "RESEND_API_KEY">> {}
}
